...
- 자바스크립트 엔진 내에선 **가비지 컬렉터(garbage collector)** 가 끊임없이 동작합니다. 가비지 컬렉터는 모든 객체를 모니터링하고, 도달할 수 없는 객체는 삭제합니다.
  ...
  ![스크린샷 2020-12-04 오후 9.15.25](md_img/스크린샷 2020-12-04 오후 9.15.25.png)
  ...
  ![스크린샷 2020-12-04 오후 9.18.00](md_img/스크린샷 2020-12-04 오후 9.18.00.png)

  - 외부로 나가는 참조는 도달 가능한 상태에 영향을 주지 않습니다. 외부에서 들어오는 참조만이 도달 가능한 상태에 영향을 줍니다. 

  ![스크린샷 2020-12-04 오후 9.19.53](md_img/스크린샷 2020-12-04 오후 9.19.53.png)
